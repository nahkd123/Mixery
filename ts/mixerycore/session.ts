    ...
    constructor() {
        ...
        document.addEventListener("keydown", event => {
            ...
            switch (keyStr) {
                ...
                case "Ctrl + Digit1": case "Ctrl + Digit2": case "Ctrl + Digit3":
                case "Ctrl + Digit4": case "Ctrl + Digit5": case "Ctrl + Digit6":
                case "Ctrl + Digit7": case "Ctrl + Digit8": case "Ctrl + Digit9":
